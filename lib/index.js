...
exports.Blonk = exports.User = exports.Salary = exports.Region = exports.Match = exports.JobListing = exports.JobCategory = exports.Country = exports.ContractType = exports.Company = exports.Chat = exports.CandidateListing = undefined;
...
process.env.MONGO_URL = _env2.default.db;
console.log(process.env.MONGO_URL);
var Blonk = {
	version: '1.0.0'
};
_mongoose2.default.createConnection(process.env.MONGO_URL, {
	server: {
		socketOptions: {
			keepAlive: 1
		}
...
Blonk.connect = function () {
	var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : process.env.MONGO_URL;

	_mongoose2.default.createConnection(url, {
		server: {
			socketOptions: {
				keepAlive: 1
			}
